...
<!--breadcrumb-->
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            <div class="btn-group">
                <a href="{{route('blog_category_list')}}" class="btn btn-primary"><i class="bi bi-arrow-left"></i> 
                    Back to {{$nav}}</a>
            </div>
        </div>
    </div>
                        ...
                        <div class="card-body">
                          <div class="row g-3">           
                             ...
                             <div class="col-6 form-group">
                                ...
                                @error('title') is-invalid @enderror" value="{{ $data->title }}" required>
                            </div>
                             ...
                             <div class="col-12 form-group">
                                ...
                                <input type="text" name="description" id="description" class="form-control 
                                 @error('description') is-invalid @enderror" value="{{ $data->description }}" required>
                            </div>
