...
<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            <div class="btn-group">
                <a href="{{route('blog_category_add')}}" class="btn btn-success"><b>+</b> Add {{$nav}}</a>
            </div>
                ...
                <table class="table align-middle" id="example">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$value->status}}</td>                            
                            <td>
                                <a href="{{route('blog_category_edit',encrypt($value->id))}}"><i class="bi bi-pencil-fill"></i></a>
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="alert-body">
                                        <form action="{{route('blog_category_delete',encrypt($value->id))}}">
                                            @csrf
