                          ...
                          <div class="row g-3">
                            <div class="col-12 form-group">
                             ...
                             <div class="col-6 form-group">
                              ...
                              <input type="number" step="0.1" max="5" name="rating" id="rating" class="form-control 
                              @error('rating') is-invalid @enderror" value="{{ $data->rating }}" placeholder="4.5">
                            </div> 
                                                     
                            <div class="col-12 form-group">
                                <label class="form-label">Review <span>*</span></label>
                                <input type="text" name="review" id="review" class="form-control
                                 @error('review') is-invalid @enderror" value="{{ $data->review }}">
                            </div>
