 ...
 <div class="row">
              <div class="col-12 col-lg-12">
                <div class="card shadow-sm border-0">
                  <form class="customer_form"  method="post" enctype="multipart/form-data" action="{{route('about_us_add')}}">
                    @csrf
                  <div class="card-body">
                      ...
                      <div class="card shadow-none border">
                        ...
                        <div class="row g-3">
                             ...
                             <div class="col-6 form-group">
                                ...
                                @error('title') is-invalid @enderror" value="{{$about_check != 0 ? $about_us->title : '' }}">
                            </div>
                                ...
                                @error('video_link') is-invalid @enderror" value="{{$about_check != 0 ? $about_us->video_link :''}}">
                            </div>

                            <div class="col-12 form-group">
                                <label class="form-label">Description <span>*</span></label>
                                <input type="text" name="description" id="description" class="form-control
                                 @error('description') is-invalid @enderror" value="{{$about_check != 0 ? $about_us->description : '' }}">
                            </div>
